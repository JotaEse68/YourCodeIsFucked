...
لا يغير YCF تلقائياً المصادقة أو المدفوعات أو واجهات API العامة أو مخططات قواعد البيانات أو التكاملات الخارجية أو الاستدعاءات الديناميكية. يدعم الإصدار الحالي تشخيص JS/TS/React وPHP/WordPress والتنظيف الآمن وفحص الجاهزية للنشر عبر `ycf release`.
