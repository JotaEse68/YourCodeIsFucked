...
execFileSync('npx', ['--no-install', 'postject', 'release/YCF-Launcher-Windows.exe', 'NODE_SEA_BLOB', 'dist/main.blob', '--sentinel-fuse', SENTINEL_FUSE], { stdio: 'inherit', shell: true });
