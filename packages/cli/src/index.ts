...
program.command('cockpit [target]').description('Write a self-contained visual audit and impact cockpit.').action((target = '.') => {
  ...
  writeFileSync(cockpitPath, cockpitHtml(report, auditReport), 'utf8');
