...
export type { ArchitecturalRefactorPlan, ModuleImportEdge, RefactorBlock, RefactorExecutionReport, RefactorOperation, RefactorBlockStatus, RiskLevel, SafetyMode, RefactorOperationKind, OperationRecord, RollbackEvent, RollbackStep, VerificationStep } from './refactor-types.js';
export { applyRefactorOperation, moduleImportGraph } from './refactor-operations.js';
...
export { writeRefactorExecutionReport } from './reporters.js';
