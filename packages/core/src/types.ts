...
export interface DuplicateGroup {
  id: string; kind: 'exact' | 'similar' | 'ast'; certainty: 'confirmed' | 'likely'; similarity: number; lines: number;
