...
export interface Finding {
  id: string;
  ruleId: 'debug-statements' | 'debug-console' | 'unused-import' | 'ai-residue' | 'suspicious-filename' | 'large-source-file' | 'long-function' | 'large-react-component' | 'react-effect-without-dependencies' | 'wordpress-dynamic-entrypoint' | 'wordpress-dynamic-callback-review' | 'wordpress-rest-route-permission' | 'wordpress-rest-route-callback-review' | 'wordpress-ajax-nonce-review' | 'wordpress-ajax-capability-review' | 'wordpress-unsanitized-input' | 'wordpress-unescaped-output' | 'high-complexity' | 'duplicate-code' | 'unused-production-dependency';
